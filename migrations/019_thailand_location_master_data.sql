-- Thailand province master data imported from https://github.com/parsilver/thailand-provinces
-- Source note: upstream repository is archived/not maintained, but kept as requested project seed data.
...
CREATE TABLE IF NOT EXISTS master_geographies (
  ...
  PRIMARY KEY (id),
  KEY idx_master_geographies_status (status, name)
...
CREATE TABLE IF NOT EXISTS master_provinces (
  ...
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY uq_master_provinces_code (code),
  KEY idx_master_provinces_geography (geography_id, status),
  KEY idx_master_provinces_name_th (name_th),
  CONSTRAINT fk_master_provinces_geography FOREIGN KEY (geography_id) REFERENCES master_geographies(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS master_amphures (
  id INT UNSIGNED NOT NULL,
  code VARCHAR(10) NOT NULL,
  name_th VARCHAR(150) NOT NULL,
  name_en VARCHAR(150) NOT NULL,
  ...
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY uq_master_amphures_code (code),
  KEY idx_master_amphures_province (province_id, status),
  KEY idx_master_amphures_name_th (name_th),
  CONSTRAINT fk_master_amphures_province FOREIGN KEY (province_id) REFERENCES master_provinces(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS master_districts (
  ...
  name_th VARCHAR(150) NOT NULL,
  name_en VARCHAR(150) NOT NULL,
  amphure_id INT UNSIGNED NOT NULL,
  status ENUM('active','inactive') NOT NULL DEFAULT 'active',
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  KEY idx_master_districts_amphure (amphure_id, status),
  KEY idx_master_districts_zip_code (zip_code),
  KEY idx_master_districts_name_th (name_th),
  CONSTRAINT fk_master_districts_amphure FOREIGN KEY (amphure_id) REFERENCES master_amphures(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;



INSERT IGNORE INTO `master_geographies` (`id`, `name`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
INSERT IGNORE INTO `master_provinces` (`id`, `code`, `name_th`, `name_en`, `geography_id`) VALUES
...
INSERT IGNORE INTO `master_amphures` (`id`, `code`, `name_th`, `name_en`, `province_id`) VALUES
...
INSERT IGNORE INTO `master_districts` (`id`, `zip_code`, `name_th`, `name_en`, `amphure_id`) VALUES
...
UPDATE master_provinces
SET name_en = 'Bueng Kan'
WHERE code = '97' AND name_th = 'บึงกาฬ';
